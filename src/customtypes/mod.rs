...
impl Int {
    ...
    pub fn init(value: i64) -> Int {
        match value {
            value if value <= i8::MAX as i64 && value >= i8::MIN as i64 => Int::I8(value as i8),
            value if value <= i16::MAX as i64 && value >= i16::MIN as i64 => Int::I16(value as i16),
            value if value <= i32::MAX as i64 && value >= i32::MIN as i64 => Int::I32(value as i32),
            _ => Int::I64(value),
        }
    }
    ...
    pub fn get_value(&self) -> i64 {
        match *self {
            Int::I8(val) => val as i64,
            Int::I16(val) => val as i64,
            Int::I32(val) => val as i64,
            Int::I64(val) => val,
        }
    }
    ...
    pub fn _get_type(&self) -> String {
        match *self {
            Int::I8(_) => "i8".to_string(),
            Int::I16(_) => "i16".to_string(),
            Int::I32(_) => "i32".to_string(),
            Int::I64(_) => "i64".to_string(),
        }
    }
